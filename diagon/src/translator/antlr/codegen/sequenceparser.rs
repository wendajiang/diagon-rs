...
type BaseParserType<'input, I> = BaseParser<
    ...
    sequenceParserExt,
    I,
    sequenceParserContextType,
    dyn sequenceListener<'input> + 'input,
>;
...
impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    ParserRecog<'input, BaseParserType<'input, I>> for sequenceParserExt
{
}

impl<'input, I: TokenStream<'input, TF = LocalTokenFactory<'input>> + TidAble<'input>>
    Actions<'input, BaseParserType<'input, I>> for sequenceParserExt
{
...
impl<'input> ProgramContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
...
pub trait ProgramContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<ProgramContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token EOF
    /// Returns `None` if there is no child corresponding to token EOF
    fn EOF(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn EOL_all(&self) -> Vec<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn EOL(&self, i: usize) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
            ...
            {
                {
                    ...
                    if (((_la) & !0x3f) == 0
                        && ((1usize << _la)
                            & ((1usize << T__0)
                                | (1usize << NormalRightArrow)
                                | (1usize << NormalLeftArrow)
                                | (1usize << Comma)
                                | (1usize << Less)
                                | (1usize << More)
                                | (1usize << Colon)
...
pub trait CommandContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<CommandContextExt<'input>>
{
    fn messageCommand(&self) -> Option<Rc<MessageCommandContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    }
    fn dependencyCommand(&self) -> Option<Rc<DependencyCommandContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
pub type MessageCommandContext<'input> =
    BaseParserRuleContext<'input, MessageCommandContextExt<'input>>;
...
impl<'input> MessageCommandContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<MessageCommandContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            MessageCommandContextExt { ph: PhantomData },
        ))
    }
}

pub trait MessageCommandContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<MessageCommandContextExt<'input>>
{
    fn text_all(&self) -> Vec<Rc<TextContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn text(&self, i: usize) -> Option<Rc<TextContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn arrow(&self) -> Option<Rc<ArrowContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn Comma(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
        self.get_token(Comma, 0)
    }
    fn dependencyID(&self) -> Option<Rc<DependencyIDContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn messageCommand(&mut self) -> Result<Rc<MessageCommandContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            MessageCommandContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 4, RULE_messageCommand);
...
pub type DependencyCommandContext<'input> =
    BaseParserRuleContext<'input, DependencyCommandContextExt<'input>>;
...
impl<'input, 'a> Listenable<dyn sequenceListener<'input> + 'a>
    for DependencyCommandContext<'input>
{
    fn enter(&self, listener: &mut (dyn sequenceListener<'input> + 'a)) {
        listener.enter_every_rule(self);
...
impl<'input> DependencyCommandContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<DependencyCommandContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            DependencyCommandContextExt { ph: PhantomData },
        ))
    }
}

pub trait DependencyCommandContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<DependencyCommandContextExt<'input>>
{
    fn text(&self) -> Option<Rc<TextContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn dependencies(&self) -> Option<Rc<DependenciesContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn dependencyCommand(
        &mut self,
    ) -> Result<Rc<DependencyCommandContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx =
            DependencyCommandContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 6, RULE_dependencyCommand);
...
impl<'input> DependencyContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<DependencyContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            DependencyContextExt { ph: PhantomData },
        ))
    }
}

pub trait DependencyContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<DependencyContextExt<'input>>
{
    fn number_all(&self) -> Vec<Rc<NumberContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn number(&self, i: usize) -> Option<Rc<NumberContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    }
    fn comparison_all(&self) -> Vec<Rc<ComparisonContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn comparison(&self, i: usize) -> Option<Rc<ComparisonContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn dependency(&mut self) -> Result<Rc<DependencyContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
pub type DependencyIDContext<'input> =
    BaseParserRuleContext<'input, DependencyIDContextExt<'input>>;
...
impl<'input> DependencyIDContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<DependencyIDContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            DependencyIDContextExt { ph: PhantomData },
        ))
    }
}

pub trait DependencyIDContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<DependencyIDContextExt<'input>>
{
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn dependencyID(&mut self) -> Result<Rc<DependencyIDContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = DependencyIDContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 10, RULE_dependencyID);
...
pub type DependenciesContext<'input> =
    BaseParserRuleContext<'input, DependenciesContextExt<'input>>;
...
impl<'input> DependenciesContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<DependenciesContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            DependenciesContextExt { ph: PhantomData },
        ))
    }
}

pub trait DependenciesContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<DependenciesContextExt<'input>>
{
    fn dependency_all(&self) -> Vec<Rc<DependencyContextAll<'input>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    }
    fn dependency(&self, i: usize) -> Option<Rc<DependencyContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(i)
    ...
    fn Colon_all(&self) -> Vec<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn Colon(&self, i: usize) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn dependencies(&mut self) -> Result<Rc<DependenciesContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = DependenciesContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 12, RULE_dependencies);
...
impl<'input> TextContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<TextContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            TextContextExt { ph: PhantomData },
        ))
    }
}

pub trait TextContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<TextContextExt<'input>>
{
    fn textInternal(&self) -> Option<Rc<TextInternalContextAll<'input>>>
    where
        Self: Sized,
    {
        self.child_of_type(0)
    ...
    fn Space_all(&self) -> Vec<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
        self.children_of_type()
    ...
    fn Space(&self, i: usize) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn text(&mut self) -> Result<Rc<TextContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
...
pub type TextInternalContext<'input> =
    BaseParserRuleContext<'input, TextInternalContextExt<'input>>;
...
impl<'input> TextInternalContextExt<'input> {
    fn new(
        parent: Option<Rc<dyn sequenceParserContext<'input> + 'input>>,
        invoking_state: isize,
    ) -> Rc<TextInternalContextAll<'input>> {
        Rc::new(BaseParserRuleContext::new_parser_ctx(
            parent,
            invoking_state,
            TextInternalContextExt { ph: PhantomData },
        ))
    }
}

pub trait TextInternalContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<TextInternalContextExt<'input>>
{
    /// Retrieves all `TerminalNode`s corresponding to token Space in current rule
    fn Space_all(&self) -> Vec<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
...
where
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn textInternal(&mut self) -> Result<Rc<TextInternalContextAll<'input>>, ANTLRError> {
        let mut recog = self;
        let _parentctx = recog.ctx.take();
        let mut _localctx = TextInternalContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog
            .base
            .enter_rule(_localctx.clone(), 16, RULE_textInternal);
...
pub trait NumberContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<NumberContextExt<'input>>
{
    ...
    fn Number(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
...
pub trait ComparisonContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<ComparisonContextExt<'input>>
{
    /// Retrieves first TerminalNode corresponding to token Less
    /// Returns `None` if there is no child corresponding to token Less
    fn Less(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn More(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
    ...
    H: ErrorStrategy<'input, BaseParserType<'input, I>>,
{
    pub fn comparison(&mut self) -> Result<Rc<ComparisonContextAll<'input>>, ANTLRError> {
        ...
        recog
            .base
            .enter_rule(_localctx.clone(), 20, RULE_comparison);
...
pub trait ArrowContextAttrs<'input>:
    sequenceParserContext<'input> + BorrowMut<ArrowContextExt<'input>>
{
    ...
    fn NormalLeftArrow(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
    ...
    fn NormalRightArrow(&self) -> Option<Rc<TerminalNode<'input, sequenceParserContextType>>>
    where
        Self: Sized,
    {
