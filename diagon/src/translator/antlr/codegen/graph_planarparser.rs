...
type BaseParserType<'input, I> =
	BaseParser<'input,graph_planarParserExt, I, graph_planarParserContextType , dyn graph_planarListener<'input> + 'input >;

type TokenType<'input> = <LocalTokenFactory<'input> as TokenFactory<'input>>::Tok;
pub type LocalTokenFactory<'input> = CommonTokenFactory;

pub type graph_planarTreeWalker<'input,'a> =
	ParseTreeWalker<'input, 'a, graph_planarParserContextType , dyn graph_planarListener<'input> + 'a>;
...
impl<'input, I> graph_planarParser<'input, I, DefaultErrorStrategy<'input,graph_planarParserContextType>>
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
...
impl<'input> graph_planarParserContext<'input> for TerminalNode<'input,graph_planarParserContextType> {}
impl<'input> graph_planarParserContext<'input> for ErrorNode<'input,graph_planarParserContextType> {}
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for graph_planarParserExt{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for graph_planarParserExt{
	fn get_grammar_file_name(&self) -> & str{ "graph_planar.g4"}
...
impl<'input> CustomRuleContext<'input> for GraphContextExt<'input>{
	...
	fn get_rule_index(&self) -> usize { RULE_graph }
	//fn type_rule_index() -> usize where Self: Sized { RULE_graph }
}
antlr_rust::type_id!{GraphContextExt<'a>}

impl<'input> GraphContextExt<'input>{
	fn new(parent: Option<Rc<dyn graph_planarParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GraphContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,GraphContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait GraphContextAttrs<'input>: graph_planarParserContext<'input> + BorrowMut<GraphContextExt<'input>>{

fn edges_all(&self) ->  Vec<Rc<EdgesContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn edges(&self, i: usize) -> Option<Rc<EdgesContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
	self.get_token(EOF, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token EOL in current rule
fn EOL_all(&self) -> Vec<Rc<TerminalNode<'input,graph_planarParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn EOL(&self, i: usize) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<GraphContextAll<'input>>,ANTLRError> {
		let mut recog = self;
...
impl<'input> CustomRuleContext<'input> for EdgesContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = graph_planarParserContextType;
	fn get_rule_index(&self) -> usize { RULE_edges }
	//fn type_rule_index() -> usize where Self: Sized { RULE_edges }
}
antlr_rust::type_id!{EdgesContextExt<'a>}

impl<'input> EdgesContextExt<'input>{
	fn new(parent: Option<Rc<dyn graph_planarParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EdgesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,EdgesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait EdgesContextAttrs<'input>: graph_planarParserContext<'input> + BorrowMut<EdgesContextExt<'input>>{
...
fn arrow_all(&self) ->  Vec<Rc<ArrowContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn arrow(&self, i: usize) -> Option<Rc<ArrowContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<EdgesContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			loop {
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << RIGHT_ARROW) | (1usize << NONE_ARROW) | (1usize << LEFT_RIGHT_ARROW) | (1usize << LEFT_ARROW))) != 0)) {break}
			}
			}
		};
		match result {
...
impl<'input> ArrowContextExt<'input>{
	fn new(parent: Option<Rc<dyn graph_planarParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ArrowContextAll<'input>> {
		Rc::new(
...
pub trait ArrowContextAttrs<'input>: graph_planarParserContext<'input> + BorrowMut<ArrowContextExt<'input>>{
...
fn RIGHT_ARROW(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
...
fn NONE_ARROW(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
...
fn LEFT_RIGHT_ARROW(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
...
fn LEFT_ARROW(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ArrowContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << RIGHT_ARROW) | (1usize << NONE_ARROW) | (1usize << LEFT_RIGHT_ARROW) | (1usize << LEFT_ARROW))) != 0)) } {
...
impl<'input> NodeContextExt<'input>{
	fn new(parent: Option<Rc<dyn graph_planarParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NodeContextAll<'input>> {
		Rc::new(
...
pub trait NodeContextAttrs<'input>: graph_planarParserContext<'input> + BorrowMut<NodeContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token ID
/// Returns `None` if there is no child corresponding to token ID
fn ID(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
	self.get_token(ID, 0)
}
/// Retrieves first TerminalNode corresponding to token STRING
/// Returns `None` if there is no child corresponding to token STRING
fn STRING(&self) -> Option<Rc<TerminalNode<'input,graph_planarParserContextType>>> where Self:Sized{
