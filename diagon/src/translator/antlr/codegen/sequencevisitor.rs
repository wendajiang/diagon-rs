...
pub trait sequenceVisitor<'input>: ParseTreeVisitor<'input,sequenceParserContextType>{
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_messageCommand(&mut self, ctx: &MessageCommandContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link sequenceParser#dependencyCommand}.
	 * @param ctx the parse tree
	 */
	fn visit_dependencyCommand(&mut self, ctx: &DependencyCommandContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link sequenceParser#dependency}.
	 * @param ctx the parse tree
	 */
	fn visit_dependency(&mut self, ctx: &DependencyContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link sequenceParser#dependencyID}.
	 * @param ctx the parse tree
	 */
	fn visit_dependencyID(&mut self, ctx: &DependencyIDContext<'input>) { self.visit_children(ctx) }

	/**
	 * Visit a parse tree produced by {@link sequenceParser#dependencies}.
	 * @param ctx the parse tree
	 */
	fn visit_dependencies(&mut self, ctx: &DependenciesContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_textInternal(&mut self, ctx: &TextInternalContext<'input>) { self.visit_children(ctx) }
	 ...
	 * @param ctx the parse tree
	 */
	fn visit_arrow(&mut self, ctx: &ArrowContext<'input>) { self.visit_children(ctx) }
