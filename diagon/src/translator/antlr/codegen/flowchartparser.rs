...
use std::any::{Any,TypeId};
	...
	pub const ruleNames: [&'static str; 11] =  [
		"program", "instruction", "noop", "element", "string", "condition", "whileloop", 
		"doloop", "group", "returninstruction", "switchinstruction"
	];
...
type BaseParserType<'input, I> =
	BaseParser<'input,flowchartParserExt, I, flowchartParserContextType , dyn flowchartListener<'input> + 'input >;
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for flowchartParserExt{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for flowchartParserExt{
	fn get_grammar_file_name(&self) -> & str{ "flowchart.g4"}
...
impl<'input> ProgramContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ProgramContextAll<'input>> {
		Rc::new(
...
pub trait ProgramContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<ProgramContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ProgramContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << T__0) | (1usize << T__2) | (1usize << T__6) | (1usize << T__7) | (1usize << T__8) | (1usize << T__10) | (1usize << T__11) | (1usize << STRING_SIMPLE_QUOTE) | (1usize << STRING_DOUBLE_QUOTE))) != 0) {
				{
				{
...
impl<'input> InstructionContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InstructionContextAll<'input>> {
		Rc::new(
...
pub trait InstructionContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<InstructionContextExt<'input>>{

fn noop(&self) -> Option<Rc<NoopContextAll<'input>>> where Self:Sized{
...
fn whileloop(&self) -> Option<Rc<WhileloopContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn doloop(&self) -> Option<Rc<DoloopContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn returninstruction(&self) -> Option<Rc<ReturninstructionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn switchinstruction(&self) -> Option<Rc<SwitchinstructionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> CustomRuleContext<'input> for NoopContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = flowchartParserContextType;
	fn get_rule_index(&self) -> usize { RULE_noop }
	//fn type_rule_index() -> usize where Self: Sized { RULE_noop }
}
antlr_rust::type_id!{NoopContextExt<'a>}

impl<'input> NoopContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NoopContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,NoopContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait NoopContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<NoopContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<NoopContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> ElementContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ElementContextAll<'input>> {
		Rc::new(
...
pub trait ElementContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<ElementContextExt<'input>>{
...
impl<'input> StringContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StringContextAll<'input>> {
		Rc::new(
...
pub trait StringContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<StringContextExt<'input>>{
...
fn STRING_SIMPLE_QUOTE(&self) -> Option<Rc<TerminalNode<'input,flowchartParserContextType>>> where Self:Sized{
...
fn STRING_DOUBLE_QUOTE(&self) -> Option<Rc<TerminalNode<'input,flowchartParserContextType>>> where Self:Sized{
...
impl<'input> ConditionContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConditionContextAll<'input>> {
		Rc::new(
...
pub trait ConditionContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<ConditionContextExt<'input>>{
...
impl<'input> CustomRuleContext<'input> for WhileloopContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = flowchartParserContextType;
	fn get_rule_index(&self) -> usize { RULE_whileloop }
...
impl<'input> WhileloopContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<WhileloopContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,WhileloopContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait WhileloopContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<WhileloopContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn whileloop(&mut self,)
	-> Result<Rc<WhileloopContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for DoloopContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = flowchartParserContextType;
	fn get_rule_index(&self) -> usize { RULE_doloop }
...
impl<'input> DoloopContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DoloopContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DoloopContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DoloopContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<DoloopContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn doloop(&mut self,)
	-> Result<Rc<DoloopContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> GroupContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GroupContextAll<'input>> {
		Rc::new(
...
pub trait GroupContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<GroupContextExt<'input>>{
...
impl<'input,'a> Listenable<dyn flowchartListener<'input> + 'a> for ReturninstructionContext<'input>{
	fn enter(&self,listener: &mut (dyn flowchartListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> ReturninstructionContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ReturninstructionContextAll<'input>> {
		Rc::new(
...
pub trait ReturninstructionContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<ReturninstructionContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ReturninstructionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 18, RULE_returninstruction);
...
pub type SwitchinstructionContext<'input> = BaseParserRuleContext<'input,SwitchinstructionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn flowchartListener<'input> + 'a> for SwitchinstructionContext<'input>{
	fn enter(&self,listener: &mut (dyn flowchartListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for SwitchinstructionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = flowchartParserContextType;
	fn get_rule_index(&self) -> usize { RULE_switchinstruction }
...
impl<'input> SwitchinstructionContextExt<'input>{
	fn new(parent: Option<Rc<dyn flowchartParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SwitchinstructionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SwitchinstructionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SwitchinstructionContextAttrs<'input>: flowchartParserContext<'input> + BorrowMut<SwitchinstructionContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn switchinstruction(&mut self,)
	-> Result<Rc<SwitchinstructionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SwitchinstructionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 20, RULE_switchinstruction);
